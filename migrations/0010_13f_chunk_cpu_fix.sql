-- v0.6.3: rebuild 13F work items with 5-position chunks.
-- This clears stale 25-position chunk payloads that can exceed the Python
-- Worker CPU budget and preserves the current safety gate on whale_score.
